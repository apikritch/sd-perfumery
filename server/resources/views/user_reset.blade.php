    ...
    <tr>
      <td align="center" style="padding:0;">
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          ...
          <tr>
            <td style="padding:36px 30px 42px 30px; background:#FFF9FB;">
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    {{-- <p>{{$details['token']}}</p> --}}
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="http://www.apikritch.com:8081/admin/reset_password/{{$details['token']}}" style="color:#ee4c50;text-decoration:underline;">Reset Password</a></p>
                  </td>
                </tr>
